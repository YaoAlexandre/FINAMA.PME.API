        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Devis_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Devis_Tenants_TenantId1",
                        column: x => x.TenantId1,
                        principalTable: "Tenants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Devis_Tiers_TiersId",
                        column: x => x.TiersId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "USD", new DateTime(2026, 5, 21, 2, 43, 40, 564, DateTimeKind.Utc).AddTicks(7336), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Local), true, false, "Dollar américain", "$", 1.0000m, null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "XOF", new DateTime(2026, 5, 21, 2, 43, 40, 573, DateTimeKind.Utc).AddTicks(9436), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Local), true, false, "Franc CFA (BCEAO)", "FCFA", 615.0000m, null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "EUR", new DateTime(2026, 5, 21, 2, 43, 40, 573, DateTimeKind.Utc).AddTicks(9533), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Local), true, false, "Euro", "€", 0.9200m, null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), "GHS", new DateTime(2026, 5, 21, 2, 43, 40, 573, DateTimeKind.Utc).AddTicks(9546), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Local), true, false, "Cedi ghanéen", "₵", 14.5000m, null },
                    { new Guid("55555555-5555-5555-5555-555555555555"), "NGN", new DateTime(2026, 5, 21, 2, 43, 40, 573, DateTimeKind.Utc).AddTicks(9553), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Local), true, false, "Naira nigérian", "₦", 1490.0000m, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devis_TenantId_Numero",
                table: "Devis",
                columns: new[] { "TenantId", "Numero" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Devis_TenantId1",
                table: "Devis",
                column: "TenantId1");

            migrationBuilder.CreateIndex(
                name: "IX_Devis_TiersId",
                table: "Devis",
                column: "TiersId");
